...
export default class Chat extends Component {
    ...
    submitConnect = event => {
        ...
        this.client.authenticateCustom({
            id : randomUserId,
            create : true,
            username : "mycustomusername"
        }).then(this.sessionHandler).catch(error => {
            errorHandler(error);
        });
            ...
            <Container fluid>
                ...
                <Form>
                    <Form.Group widths='equal'>
                        <Form.Field control={Input} label='Host' value={this.state.host}
                                    onChange={this.changeField('host')}/>
                        <Form.Field control={Input} label='Port' value={this.state.port}
                                    onChange={this.changeField('port')}/>
                        <Form.Field control={Input} label='Server Key' value={this.state.serverkey}
                                    onChange={this.changeField('serverkey')}/>
                    </Form.Group>
                    <Form.Group inline>
                        <Form.Field control={Checkbox} label='Use SSL' checked={this.state.ssl}
